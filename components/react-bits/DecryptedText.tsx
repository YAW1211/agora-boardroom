  ...
  useEffect(() => {
    ...
    intervalRef.current = setInterval(() => {
      setRevealedIndices((previousRevealed) => {
        if (sequential) {
          if (direction === "forward") {
            if (previousRevealed.size < text.length) {
              const nextIndex = getNextIndex(previousRevealed as Set<number>);
              const newRevealed = new Set(previousRevealed as Set<number>);
        ...
        if (direction === "forward") {
          setDisplayText(shuffleText(text, previousRevealed as Set<number>));
          currentIteration++;
        ...
        if (direction === "reverse") {
          let currentSet = previousRevealed as Set<number>;
